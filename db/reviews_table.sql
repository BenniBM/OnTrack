...
-- 16.08.2025
ALTER TABLE reviews 
ADD COLUMN health INTEGER DEFAULT 3,
ADD COLUMN relationships INTEGER DEFAULT 3,
ADD COLUMN progressing INTEGER DEFAULT 3,
ADD COLUMN work INTEGER DEFAULT 3;

-- 16.08.2025
ALTER TABLE reviews 
ADD COLUMN cash DECIMAL(10,2),
ADD COLUMN weight DECIMAL(5,2),
ADD COLUMN screentime INTEGER;